...
//	if(SCL_GPIO_Port==GPIOA) I2C->SCL_GPIO_CLK=RCC_APB2Periph_GPIOA;//我也很想用switch，但是指针变量不能用于switch￣へ￣
...
//    
//	
	HAL_I2C_Mem_Write(&hi2c1,SlaveAddress,REG_Address,1,&REG_data,1,100);
	return 1;
}
...
//    I2C_NoAck(I2C);
//    I2C_Stop(I2C);
	REG_data=HAL_I2C_Mem_Read(&hi2c1,SlaveAddress,REG_Address,1,&REG_data,1,100);
	return REG_data;
}		
...
//  }
//		I2C_Stop(I2C);
	HAL_I2C_Mem_Read(&hi2c1,addr,readAddr,1,pBuffer,NumByteToRead,100);
	return 1;
